...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Space Location</div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('latitude', null ,['class' => $errors->has('latitude') ? 'form-control is-invalid'
                        : 'form-control', 'id' => 'lat']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('longitude', null ,['class' => $errors->has('longtitude') ? 'form-control is-invalid'
                        : 'form-control', 'id' => 'lng']) !!}
